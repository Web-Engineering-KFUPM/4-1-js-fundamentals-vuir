...
const SCHOOL = "MyCollege";
console.log(SCHOOL);
//const SCHOOL = "NewCollege"; //Reassignment fails because constants can't be reassigned after their initial declaration.(script.js:22 Uncaught SyntaxError: Identifier 'SCHOOL' has already been declared (at script.js:22:7))
...
"2" + 3; // The first two concatenate because when one operand is a string, JavaScript converts the other operand to a string and performs string concatenation.
2 + "3";   
2 + 3;     
